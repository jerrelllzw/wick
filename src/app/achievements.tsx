      ...
      <View style={styles.inner}>
        <View style={styles.header}>
          ...
          <ThemedText type="small" themeColor="textSecondary">
            {earned} of {achievements.length} earned · one-off milestones, no daily grind
          </ThemedText>
        </View>
...
function AchievementRow({ item }: { item: AchievementProgress }) {
  ...
  return (
    <ThemedView type="backgroundElement" style={[styles.row, !unlocked && styles.rowLocked]}>
      <View
        style={[
          styles.badge,
          { backgroundColor: unlocked ? tone.warnBg : tone.neutralBg, borderColor: tone.hairline },
        ]}>
